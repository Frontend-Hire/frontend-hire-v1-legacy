...
export default function Footer({ isCompact, className }: FooterProps) {
  ...
  return (
    <footer className="mt-4 grid grid-cols-1 justify-items-stretch gap-4 border-t-2 p-2 text-sm text-gray-300 xs:grid-cols-2 md:px-10 md:py-2">
