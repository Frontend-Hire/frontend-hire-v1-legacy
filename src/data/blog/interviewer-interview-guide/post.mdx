...
This might sound obvious, but it is important to read the candidate's resume before the interview. This is because **their resume is what they have mostly worked on and are comfortable talking about.** You can ask them questions about their projects, the technologies they have worked on, and the challenges they have faced.
...
I would also suggest having a backup plan in case the internet goes down. You can use **your phone as a hotspot that would use WiFi and switch to mobile data in case of any issues**.
...
It is always a good idea to have a notebook and a pen with you. This helps you **follow up on the candidate's answers** and take notes. It also helps you to jot down any questions that come to your mind during the interview.
...
**All that matters is that you are facing towards the camera!**
...
If the role requires the candidate to code, you should allow them to use the internet and an IDE. This is because **in real life, they will be using the internet and an IDE to write code.**

**Also, allow them to use AI if the company uses it.** This will help you to see how they use the tools to solve problems. Of course, do let them know that they should not be using the internet to look up the answers to the questions you ask them but rather to look up the documentation or to search for the best way to solve a problem.

### Ask your prepared questions

Start the interview by asking the questions you have prepared. This will help you to get a good understanding of the candidate's skills and experience. So, you can **optimize the rest of the interview based on their answers.**

### Aim for a conversation rather than an interrogation

The interview should be a two-way conversation. You should be asking questions and the candidate should be answering them. But it should not feel like an interrogation. **Pitch in your thoughts and experiences as well.** This will help the candidate to feel comfortable and open up.

### Be mindful of the time

Sometimes, candidates might take a long time to answer a question. This is not necessarily a bad thing. They might be thinking about the best way to answer the question. But if you feel that the candidate is taking too long, you can gently nudge them to move on to the next question. **Judging them on a single question because you couldn't ask more questions is not fair.**

### Make it a pair programming session

**If the role requires the candidate to code, you should make it a pair programming session.** If the candidate does join the company, they will be working with a team. So, it is important to see how they work with others.
...
If time allows, you should give feedback to the candidate. This will help them to understand where they stand and what they need to work on. This will also help them to improve for future interviews. **Your direct feedback helps better than you passing on the feedback to the recruiter.**

## After the interview

### Pass on the feedback to the recruiter immediately 

**Time will decay the memory of the interview.** So, it is important to pass on the feedback to the recruiter immediately. Try to avoid giving quantitative feedback like "I rate the candidate 7/10". Instead, give qualitative feedback like "The candidate was good at problem-solving but needs to work on their communication skills".

**Also, do not be biased in any way.** Do not let any sad stories from the candidate's life affect your decision. You should only be judging them based on their skills and experience. Bias will only lead to a bad hire.
