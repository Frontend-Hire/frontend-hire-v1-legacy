This guide is broken down into three parts: **before**, **during**, and **after** the interview.
...
By researching the company, you will be ready to answer questions like **"Why do you want to work here?"** or **"What do you know about our company?"**.
...
Their **most used technologies, their previous work, and their interests** can give you a good idea of what to expect from the interview.
...
Also, helps solve those **logical problems on paper first**.
...
Do not try to memorize the introduction. Just have a general idea of what you want to say. **Keep it natural** and don't sound like you are reading from a script.
...
**Join the meeting 5 minutes before the scheduled time.** This will give you some time to relax and prepare yourself for the interview. Also, might give you extra time with the interviewer if they arrive early too.
...
**Make notes** of the question if you are solving a problem. This will help you to keep track of the problem and the solution.
...
The interviewer will be happy to help you understand the question better. If you don't know the answer, it is okay to say that you don't know the answer and ask for a hint or try to give an assumption on how it could be solved.

### Talk through the solution while solving

If you are solving a problem, make sure you talk through the solution while solving the problem. This will help the interviewer to understand your thought process. Any fellow developer would love to hear your thought process.

**Pair programming is a great way to solve problems.** This is the same thing. You are just explaining your thought process to the interviewer. The interviewer would also happily participate in the discussion.
...
You could get the feedback later from the recruiter, but it is **always good to get the feedback from the interviewer directly.**
...
Check all the answers you gave in the interview. Doing this immediately after the interview strengthens your memory and you can remember the questions and your answers better.

**Create Flash Cards if you get something wrong again and again.**
...
Also, **let the recruiter know of any alternative candidates you think would be a good fit for the role.**
...
**Recruiters are some of the people who will help you in the future with other opportunities.** They would prefer you over other new candidates since you have previously cleared the interview process.

---

#### Have an interview coming up? You can book a mock interview with folks at Frontend Hire to help you prepare for the interview. **[Book a mock interview](/interviews/mock-personal-interview)**