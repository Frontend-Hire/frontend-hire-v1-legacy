...
<Callout>
We also have [a corresponding course](/courses/dynamic-pricing-page/overview) where we implement a decent solution. Though, we would suggest you read this system design guide first.
</Callout>
...
<Callout>
`Geotargeting` is the word used to describe this process of delivering content based on the user's location.
</Callout>
