...
import GetIP from './rich-components/get-ip';
...
This IP Address lookup is a great way to get the user's location and fits perfectly for our requirement as there is no friction with the user.