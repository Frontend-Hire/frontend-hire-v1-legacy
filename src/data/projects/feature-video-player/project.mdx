...
export const meta = {
  ...
  difficulty: 'hard',
  description: 'You see clones of Netflix on the internet but not the video player. Just have a look at the sophistication of Netflix\'s or any prominient video streaming service\'s video player and try building one of similar quality.',
