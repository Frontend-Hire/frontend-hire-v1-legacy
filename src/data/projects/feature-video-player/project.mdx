...
export const meta = {
  ...
  difficulty: 'hard',
  description: 'You see clones of Netlfix on the internet but not the video player. Just have a look at the sophistication of Netflix\'s or any prominient video streaming service\'s video player and try building one of similar quality.',
  tasks: ['Setup Vite Project', 'Vitest & React Testing Library', 'UseReducer for State Management', 'Video Playback', 'Custom Controls', 'Skip Button', 'Responsive Design', 'Performance Optimization', 'Accessibility'],
...
You see a lot of clones of Netflix on the internet but not the video player. Imagine you join a company that is building a video streaming service and you would rarely be responsible for building the whole project rather you would be assigned to build a component of the project. So, you are assigned to build a video player component for the project. Just have a look at the sophistication of Netflix's or any prominient video streaming service's video player and try building one of similar quality.
