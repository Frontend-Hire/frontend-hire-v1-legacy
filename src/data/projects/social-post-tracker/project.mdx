...
export const meta = {
  title: 'Social Posts Tracker/Manager',
  difficulty: 'medium',
...
# Social Posts Tracker/Manager

Developing a Social Posts Tracker/Manager offers a unique opportunity to create a tool that not only stores social media posts but also provides insights and optimizations for platforms like LinkedIn and Twitter. This project focuses on the use of Excalidraw for creating visual content and a rich text editor for crafting post text, with Firebase or Supabase as the backend service.

- Rough time estimate: 2-3 weeks
- Example Product: [Buffer](https://buffer.com/)
...
<ProjectTasks>
  ...
  <ProjectTaskItem id={4} taskName='Feature: Optimize for LinkedIn Posts'>
    ...
    - If also posting directly to LinkedIn, how would you handle @Tags and #Hashtags?
  </ProjectTaskItem>
  ...
  <ProjectTaskItem id={5} taskName='Feature: Optimize for Twitter Posts'>
    ...
    - If also posting directly to Twitter, how would you handle @Tags and #Hashtags?
  </ProjectTaskItem>
