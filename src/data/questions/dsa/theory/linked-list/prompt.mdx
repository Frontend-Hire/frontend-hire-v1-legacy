...
import linkedList from '@/assets/dsa/linked-list.png';
import doubleLinkedList from '@/assets/dsa/double-linked-list.png';
import circularLinkedList from '@/assets/dsa/circular-linked-list.png';
import circularDoubleLinkedList from '@/assets/dsa/circular-double-linked-list.png';
...
<div className='flex justify-center items-center'>
    <Image src={linkedList} height={600} width={600} alt="Linked List" priority  />
</div>
...
<div className='flex justify-center items-center'>
    <Image src={linkedList} height={600} width={600} alt="Singly Linked List" priority  />
</div>
...
<div className='flex justify-center items-center'>
    <Image src={doubleLinkedList} height={600} width={600} alt="Doubly Linked List" priority  />
</div>
...
<div className='flex justify-center items-center'>
    <Image src={circularLinkedList} height={600} width={600} alt="Circular Linked List" priority  />
</div>
...
<div className='flex justify-center items-center'>
    <Image src={circularDoubleLinkedList} height={600} width={600} alt="Circular Doubly Linked List" priority  />
</div>
