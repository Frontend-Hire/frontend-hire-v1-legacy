...
export const meta = {
  ...
  difficulty: 'medium',
  description: "This challenge involves creating a job application form, focusing on HTML form elements and accessibility. It's a practical task that reflects real-world web development scenarios.",
  template: 'static',
  files: {
    '/index.html': {
