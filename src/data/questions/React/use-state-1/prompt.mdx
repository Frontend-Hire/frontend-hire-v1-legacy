export const meta = {
  ...
  difficulty: 'easy',
  description:
    "Dive into 'useState - 1', an easy-level React coding challenge designed to solidify your understanding of the useState hook. Tasked with creating, managing, and displaying tasks, this exercise is perfect for beginners looking to grasp the essentials of state management in React. Enhance your React skills by mastering one of its most fundamental hooks!",
  template: 'react',
...
- <a target="_blank" href="https://react.dev/learn/rendering-lists#where-to-get-your-key">Rendering Lists: Where to get your key</a> - A guide to understanding keys.
- <a target="_blank" href="https://www.geeksforgeeks.org/how-to-create-an-unique-id-in-reactjs/">How to create an unique id in ReactJS ?</a> - An article on GeeksForGeeks.