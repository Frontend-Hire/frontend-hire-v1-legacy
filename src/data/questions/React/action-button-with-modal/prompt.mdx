export const meta = {
  ...
  difficulty: 'medium',
  description:
    "Master React Modal Optimization with this coding challenge. Designed for intermediate developers, this task focuses on enhancing modal implementation in React, reducing unnecessary re-renders, especially in complex components. Ideal for honing state management and performance optimization skills in real-world scenarios.",
  template: 'react',
  dependencies: {
    'react-modal': 'latest'
  },
