...
<Callout>
The **spread operator** is used when you need to split an array, object, or iterable into individual elements or properties.
</Callout>
...
<Callout>
The **rest operator** is used to gather a collection of elements or properties into an array or object, typically in destructuring or function arguments.
</Callout>
...
<Callout>
**Tip:** The key difference between spread and rest is context: **Spread** expands values, while **Rest** collects values. Both use the same syntax (`...`), but their behavior changes based on whether they are in function calls, destructuring, or parameter lists.
</Callout>
