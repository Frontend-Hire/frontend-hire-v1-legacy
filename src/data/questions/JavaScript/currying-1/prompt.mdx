export const meta = {
  ...
  difficulty: 'hard',
  description:
    "In this challenge, you're tasked with implementing a filterBy function that utilizes the concept of currying in JavaScript. This function should allow users to filter an array of objects based on a specified property and its value.",
  template: 'test-ts',
  files: {
    '/index.js': {
