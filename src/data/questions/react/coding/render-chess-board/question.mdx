...
- Ranks are numbered from 1 to 8 and files are a to h
- The squares on the board should alternate colors with the lightest color on the top left corner
- Clicking the square should change the color to red of the square and display the rank and file on the square in a contrasting (visble) color
