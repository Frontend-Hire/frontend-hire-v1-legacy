...
<Callout>
These `config.toml` file inside the `supabase` folder contains the configuration for the Supabase CLI. This helps you configure the Supabase project for auth, database, etc.,
