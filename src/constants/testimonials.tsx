export const TESTIMONIALS = [
  ...
  },
  {
    ...
    testimonial: (
      <>
        <p>
          We have worked together and I found Hruthik{' '}
          <strong>highly dedicated and skilled professional.</strong> He is
          always keen to explore new things and used to introduce the latest
          tech to the team(with so many pros in it than the ones we were already
          using in our projects). He&apos;s a great teammate to work with.{' '}
