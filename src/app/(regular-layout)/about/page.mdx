...
import vaishnavaImage from '@/assets/team/vaishnava.jpg';
...
- We are already working on hiring tools to help companies employ good talent (some tools should be out by late-2024).

## Our Team

We are a small team, our founder, his design friend, a few interns, and a few excellent folks from the community providing discounted services through us. We are working hard to make this happen. We are always looking for feedback and suggestions. Please feel free to reach out to us at [info@frontendhire.com](mailto:info@frontendhire.com)
...
<TeamMember
  name="Vaishnava Samudrala"
  headline="Product Designer | Currently pursuing Masters in HCI"
  linkedIn="https://www.linkedin.com/in/vaishnavasamudrala/"
  website="https://www.vaishnavasamudrala.com/"
  image={vaishnavaImage}
/>
