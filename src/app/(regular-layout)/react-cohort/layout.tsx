      ...
      <div className="mb-8 w-full rounded-xl border-2 bg-card px-4 py-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">
            Learn Core React and some of its ecosystem in 2 days.
          </h2>
          <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-zinc-400">
            We will cover 80% of React in 2 days. This 80% is what you will use
          ...
          <Button
            ...
            asChild
          >
            <Link href="/react-cohort/save-spot">Save your spot</Link>
          </Button>
        </div>
      </div>
    </article>
