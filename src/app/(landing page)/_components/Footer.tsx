...
export default function Footer() {
  ...
  return (
    <footer className="grid grid-cols-1 justify-items-stretch gap-4 border-t-2 p-[10px] text-sm text-gray-300 xs:grid-cols-2 md:px-[40px] md:py-[10px]">
      <div className="flex flex-col gap-4 xs:items-start">
        <Link href="/">
          <HeaderLogo />
        </Link>
        <Social />
